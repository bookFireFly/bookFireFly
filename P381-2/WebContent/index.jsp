...
<body>
	<table align="center" border="0" cellpadding="0" cellspacing="0"
		...
		<tr>
			<td background="images/middle.jpg"><br>
				<form action="BookServlet?command=add" method="post"
					onsubmit="return add();">
					<table border="0" align="center" width="500">
						...
						<tr>
							...
							<td colspan="3"><textarea name="description" cols="30"
									rows="3"></textarea></td>
						</tr>
						<tr>
							<td colspan="4" align="center"><input type="submit"
								value="添 加"> <input type="reset" value="重 置"></td>
						</tr>
					</table>
				</form> <c:if test="${books != null}">
